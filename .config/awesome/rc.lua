...
beautiful.init(themes_dir .. "/arch_dark/theme.lua")
...
{layouts[1], layouts[10], layouts[2], layouts[2], layouts[10], layouts[1], layouts[10]}) end
...
myplacesmenu = {
   { "Home Folder", "urxvt -e ranger /home/nu/" },
   { "Computer", "urxvt -e ranger /" },
   { "Desktop", "urxvt -e ranger /home/nu/Desktop" },
   { "Documents", "urxvt -e ranger /home/nu/Documents" },
   { "Downloads", "urxvt -e ranger /home/nu/Downloads" },
   { "Games", "urxvt -e ranger /home/nu/Games" },
   { "Music", "urxvt -e ranger /home/nu/Music" },
   { "Server", "urxvt -e ranger /home/nu/public_html" },
   { "Pictures", "urxvt -e ranger /home/nu/Pictures" },
   { "Torrents", "urxvt -e ranger /home/nu/Torrents" },
   { "Videos", "urxvt -e ranger /home/nu/Videos" }
}
...
mysysmenu = {
   ...
   { "Terminal", terminal },
   { "Thunar", "thunar" },
   { "Tmux", "urxvt -e tmux new" },
   { "View processes", "urxvt -e htop" },
...
vicious.register(oswidget, vicious.widgets.os, "<span color='"..beautiful.fg_widget_text.."'>KERNEL </span><span color='"..beautiful.fg_widget_subtext.."'>$2</span>", 300)
osicon = wibox.widget.imagebox(beautiful.os_icon)

----| Cpu widget |----------------------------------------------------------------------------------------------
cpuwidget = wibox.widget.textbox()
vicious.cache(vicious.widgets.cpu)
vicious.register(cpuwidget, vicious.widgets.cpu, "<span color='"..beautiful.fg_widget_text.."'>CPU </span><span color='"..beautiful.fg_widget_subtext.."'>$2% $3% $4% $5%</span>", 3)
...
vicious.register(memwidget, vicious.widgets.mem, "<span color='"..beautiful.fg_widget_text.."'>MEM </span><span color='"..beautiful.fg_widget_subtext.."'>$2 MB</span>", 21)
...
vicious.register(netwidget, vicious.widgets.net,"<span color='"..beautiful.fg_widget_text.."'>DOWN </span><span color='"..beautiful.fg_widget_subtext.."'>${wlo1 down_kb} kB/s</span><span color='"..beautiful.fg_line.."'> | </span><span color='"..beautiful.fg_widget_text.."'>UP </span><span color='"..beautiful.fg_widget_subtext.."'>${wlo1 up_kb} kB/s</span>", 1)
...
vicious.register(fswidgeth, vicious.widgets.fs, "<span color='"..beautiful.fg_widget_text.."'> ${/home avail_gb}GB</span>", 64)
...
vicious.register(volwidget, vicious.widgets.volume,"<span color='"..beautiful.fg_widget_text.."'>$1%</span>",2,"Master")

volwidget:buttons(awful.util.table.join(
    awful.button({ }, 1, function () awful.util.spawn("amixer -q sset Master toggle", false) end),
    awful.button({ }, 3, function () awful.util.spawn("urxvt -e alsamixer", true) end),
    awful.button({ }, 4, function () awful.util.spawn("amixer sset Master playback 5%+", false) end),
    awful.button({ }, 5, function () awful.util.spawn("amixer sset Master playback 5%-", false) end)
))
...
vicious.register(volumewidget, vicious.widgets.volume,
  function (widget, args)
    if args[1] == 0 or args[2] == "♩" then
      volumewidget:set_image(beautiful.volume_00)
    elseif args[1] > 90 then
      volumewidget:set_image(beautiful.volume_100)
    elseif args[1] > 80 then
      volumewidget:set_image(beautiful.volume_90)
    elseif args[1] > 70 then
      volumewidget:set_image(beautiful.volume_80)
    elseif args[1] > 60 then
      volumewidget:set_image(beautiful.volume_70)
    elseif args[1] > 50 then
      volumewidget:set_image(beautiful.volume_60)
    elseif args[1] > 40 then
      volumewidget:set_image(beautiful.volume_50)
    elseif args[1] > 30 then
      volumewidget:set_image(beautiful.volume_40)
    elseif args[1] > 20 then
      volumewidget:set_image(beautiful.volume_30)
    elseif args[1] > 10 then
      volumewidget:set_image(beautiful.volume_20)
    else
      volumewidget:set_image(beautiful.volume_10)
    end
  end,
  2, "Master")
...
for s = 1, screen.count() do
    ...
    myleftwibox[s] = awful.wibox({ position = "left", height = "12", screen = s , width = 45})
    mywibox[s] = awful.wibox({ position = "top", height = "12", screen = s , width = 500})
...
client.connect_signal("manage", function (c, startup)
    ...
    if titlebars_enabled and (c.type == "normal" or c.type == "dialog") then
        ...
        awful.titlebar(c,{size="9"}):set_widget(layout)
    end
end)
